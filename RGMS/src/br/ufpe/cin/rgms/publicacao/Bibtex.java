...
public class Bibtex {
	...
	public Bibtex(Publicacao publicacao) {
		...
		// Constr�i string de autores no formato bibtex blabla, blab and
		// blabla2, blabla
		...
		// Constr�i string de autores n�o-membros e caso contenha algum
		// conte�do, � concatenada com a string de autores membros
